...
export const getDiscount = (id) => httpClient.get(`/discounts/${id}`);
...
export const createDiscount = (data) => httpClient.post("/discounts", data);
...
export const deleteDiscount = (id) => httpClient.delete(`/discounts/${id}`);
